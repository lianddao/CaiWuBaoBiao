 ...
 */
public interface JingYingFeiYongService extends IService<JingYingFeiYong> {

    /**
     * 从Excel导入数据
     */
    @Transactional
    List<JingYingFeiYong> importJingYingFeiYong(MultipartFile file);

    /**
     * 指定日期的数据
     */
    List<JingYingFeiYong> defaultList(String day);

    /**
     * 获取唯一对象
     */
    JingYingFeiYong getUnique(String day, String code);
