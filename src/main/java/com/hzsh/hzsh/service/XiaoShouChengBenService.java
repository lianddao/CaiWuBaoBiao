 ...
 */
public interface XiaoShouChengBenService extends IService<XiaoShouChengBen> {

    /**
     * 从Excel导入数据
     */
    @Transactional
    List<XiaoShouChengBen> importXiaoShouChengBen(MultipartFile file);

    /**
     * 指定日期的数据
     */
    List<XiaoShouChengBen> defaultList(String day);

    /**
     * 获取唯一对象
     */
    XiaoShouChengBen getUnique(String day, String code);
