 ...
 * 税金 - HZSH_SHUIJIN
 */
public interface ShuiJinService extends IService<ShuiJin> {

    /**
     * 从Excel导入数据
     */
    @Transactional
    List<ShuiJin> importShuiJin(MultipartFile file);

    /**
     * 指定日期的数据
     */
    List<ShuiJin> defaultList(String day);

    /**
     * 获取唯一对象
     */
    ShuiJin getUnique(String day, String code);
