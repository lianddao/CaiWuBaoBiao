...
public class SignatureUtils {
	...
	/*
	 * public static void main(String[] args) throws Exception { String clientSecret
	 * = "0osTIhce7uPvDKHz6aa67bhCukaKoYl4"; //参数签名算法测试例子 HashMap<String, String>
	 * signMap = new HashMap<String, String>(); signMap.put("APP_ID",
	 * "1552274783265"); signMap.put("SIGN_TYPE", SignType.SHA256.name());
	 * signMap.put("TIMESTAMP", DateUtils.getCurrentTimestampStr());
	 * signMap.put("NONCE",RandomValueUtils.randomAlphanumeric(16)); String sign =
	 * SignatureUtils.getSign(signMap, clientSecret); System.out.println("签名结果:" +
	 * sign); signMap.put("SIGN", sign); System.out.println("签名参数:" +
