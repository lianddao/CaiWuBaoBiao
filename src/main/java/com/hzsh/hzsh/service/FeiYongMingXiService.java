 ...
 * 费用明细 - [HZSH_FEI_YONG]
 */
public interface FeiYongMingXiService extends IService<FeiYongMingXi> {

    /**
     * 从Excel底稿导入数据
     */
    @Transactional
    List<FeiYongMingXi> importFeiYong(MultipartFile file);

    /**
     * 指定日期的数据
     */
    List<FeiYongMingXi> defaultList(String day);

    /**
     * 获取唯一对象
     */
    FeiYongMingXi getUnique(String day, String name);
