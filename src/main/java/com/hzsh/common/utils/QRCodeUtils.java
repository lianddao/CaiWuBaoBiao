...
public class QRCodeUtils {
	 ...
	 * { String data = "http://www.baidu.com"; // logo图片路径(这是相对路径) File logoFile =
	 * new File("img/logo/28.png"); BufferedImage image =
	 * QRCodeUtils.createQRCode(data); // 生成图片 不需要的话注释即可 //ImageIO.write(image,
	 * "png", new File("result7.png")); ByteArrayOutputStream os = new
	 * ByteArrayOutputStream(); ImageIO.write(image, "jpg", os); }
	 */
    /**
